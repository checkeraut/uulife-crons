...
_Última corrida: 2026-08-19 13:24 UTC (optimizador diario en GitHub Actions)_
...
|---|---|---|---|---|---|---|
| 1120 | 564 | 50% | 38 | 1 | 0 | 0 |

## A/B de asuntos (paso 1, acumulado)
| variante | asunto | enviados | aperturas únicas |
|---|---|---|---|
| A | your {{compound}} timeline | 264 | 105
| B | before your next order | 264 | 94

## Acción de hoy
A/B sigue juntando datos (tasas: 40%, 36%)
